    ...
    <footer className="relative bg-black text-zinc-400 py-20 px-6 md:px-12 w-full font-mono text-xs tracking-widest flex flex-col justify-between min-h-[50vh] border-t border-zinc-900 overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full font-medium relative z-10">
        <div className="flex flex-col gap-1.5">
          <p className="text-white font-bold">// System Architecture</p>
          <p className="text-zinc-400">Full-Stack Web Engineering</p>
          <p className="text-zinc-400">AI & Machine Learning Solutions</p>
        </div>
        ...
        <div className="flex flex-col gap-1.5 md:items-center">
          ...
          <a href="#projects" className="underline hover:text-white transition-colors mt-1 underline-offset-4 decoration-1 text-zinc-300">View Work</a>
        </div>
        
        <div className="flex flex-col gap-1.5 md:items-end">
          <p className="text-white font-bold">// Region</p>
          <p className="text-zinc-400">India / Worldwide</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full items-end font-medium relative z-10">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-zinc-500 font-mono text-[10px]">
            &copy; {new Date().getFullYear()} Dasari Venkata Ratna Sri Sushmita | Built with React & Tailwind
          </p>
        </div>
        
        <div className="flex flex-col gap-1 md:items-center">
          <a href="mailto:sushmitadasari@gmail.com" className="underline hover:text-white transition-colors underline-offset-4 decoration-1 lowercase text-zinc-300">
            sushmitadasari@gmail.com
          </a>
        </div>
